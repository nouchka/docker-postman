...
WORKDIR /tmp
RUN apt-get update && \
	DEBIAN_FRONTEND=noninteractive apt-get -yq --no-install-recommends install wget tar ca-certificates libcanberra-gtk-module libx11-xcb-dev libxtst-dev libxss-dev libgconf2-dev libnss3 && \
